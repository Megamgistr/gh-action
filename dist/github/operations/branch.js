...
function setupWorkingBranch(baseBranch, context, octokit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(`Git status ${yield (0, bun_1.$) `git status`}`);
        console.log(`Git branch ${yield (0, bun_1.$) `git branch --show-current`}`);
        console.log(`Git diff ${yield (0, bun_1.$) `git diff`}`);
